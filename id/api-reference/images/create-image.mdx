---
title: "Buat Gambar"
openapi: "/openapi/id.json POST /v1/images/generations"
...
- `nano-banana-2` mendukung `aspect_ratio` dan `resolution` (`1k`, `2k`, `4k`) untuk text-to-image dan image-to-image.
...
<ParamField body="resolution" type="string">
  Resolusi bergantung pada model. `gemini-3.1-flash-image`, `gemini-3-pro-image`, `nano-banana-2`, dan `nano-banana-pro` mendukung `1k`, `2k`, `4k`; model gambar Grok Imagine mendukung `1k` dan `2k`. Kirim field ini hanya jika model dan operasi yang dipilih mendukungnya secara eksplisit.
</ParamField>
...
Gunakan `GET /v1/models?recommended_for=image` untuk model gambar, kemampuan, dan harga saat ini.
