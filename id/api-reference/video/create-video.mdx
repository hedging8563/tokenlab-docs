---
title: "Buat video"
openapi: "/openapi/id.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  ID material Seedance TokenLab yang dikembalikan oleh [Membuat Aset Material](/id/api-reference/video/create-material-asset). Gunakan setelah material menjadi `ACTIVE` dengan model Seedance yang dapat menggunakan pustaka material TokenLab.
</ParamField>
