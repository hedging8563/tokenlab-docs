---
title: "Buat Model 3D"
openapi: "/openapi/id.json POST /v1/3d/generations"
...
Sebelum mengirim field opsional, periksa parameter yang diterima model melalui `GET /v1/models/{model}`. Contoh hanya mengirim `model` dan `prompt`.
...
<ParamField body="format" type="string">
  Format keluaran; dukungan dan nilai yang diizinkan bergantung pada model yang dipilih.
</ParamField>

<ParamField body="quality" type="string">
  Pengaturan kualitas; dukungan dan nilai yang diizinkan bergantung pada model yang dipilih.
</ParamField>
...
<ParamField body="seed" type="integer">
  Seed bilangan bulat, jika didukung oleh model yang dipilih.
</ParamField>
