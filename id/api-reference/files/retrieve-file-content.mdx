...
openapi: "/openapi/id.json GET /v1/files/{file_id}/content"
...
Konten file batch dikembalikan sebagai JSONL atau teks biasa. Konten referensi gambar yang dibuat oleh TokenLab dapat diproksikan sebagai konten biner ketika penyedia file pendukung mendukung pengambilan konten.
...
<ResponseField name="body" type="binary|string">Konten file. Simpan atau uraikan sesuai `Content-Type`; uraikan JSONL baris demi baris.</ResponseField>
<ResponseField name="custom_id" type="string">ID yang mencocokkan item input batch dengan hasilnya.</ResponseField>
