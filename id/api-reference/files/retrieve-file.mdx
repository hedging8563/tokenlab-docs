---
title: "Ambil File"
openapi: "/openapi/id.json GET /v1/files/{file_id}"
...
## File Referensi Gambar

Endpoint ini juga dapat mengembalikan metadata untuk file referensi gambar yang dibuat oleh TokenLab. Field `status` bersifat opsional dan mungkin tidak ada untuk keluarga file yang tidak menyediakannya.
