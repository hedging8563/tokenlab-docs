...
Pada klien stdio lokal, gunakan nama `tokenlab`, perintah `npx`, argumen terpisah `-y` dan `@tokenlabai/mcp-server`, serta biarkan direktori kerja kosong. Gunakan `@tokenlabai/mcp-server@0.6.17` untuk mengunci rilis yang saat ini telah diverifikasi.
