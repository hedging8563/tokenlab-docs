...
| **Penalaran kompleks** | `gpt-5.4`, `claude-opus-4-6` | Logika dan perencanaan yang lebih baik |
...
```python
FALLBACK_CHAIN = ["gpt-5.6-terra", "claude-sonnet-5", "gemini-3.5-flash"]
