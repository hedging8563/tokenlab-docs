---
title: "Tạo Hình Ảnh"
openapi: "/openapi/vi.json POST /v1/images/generations"
...
- `nano-banana-2` hỗ trợ `aspect_ratio` và `resolution` (`1k`, `2k`, `4k`) cho cả text-to-image và image-to-image.
...
<ParamField body="resolution" type="string">
  Độ phân giải phụ thuộc vào model. `gemini-3.1-flash-image`, `gemini-3-pro-image`, `nano-banana-2` và `nano-banana-pro` hỗ trợ `1k`, `2k`, `4k`; model ảnh Grok Imagine hỗ trợ `1k`, `2k`. Chỉ gửi trường này khi model và thao tác đã chọn hỗ trợ rõ ràng.
</ParamField>
...
Tra cứu `GET /v1/models?recommended_for=image` để xem model ảnh, khả năng và giá hiện tại.
