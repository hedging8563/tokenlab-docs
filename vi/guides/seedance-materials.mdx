...
Thư viện tài nguyên áp dụng quy tắc dọn dẹp không hoạt động 30 ngày: tài nguyên đã tải lên từ 30 ngày trở lên và không được tham chiếu bởi bất kỳ yêu cầu tạo nào trong 30 ngày qua sẽ bị xóa tự động. Việc xóa là vĩnh viễn và không thể khôi phục.

- Tham chiếu ID tài nguyên trong yêu cầu tạo (`material_asset_id`, `material_asset_ids` hoặc `asset://<id>`) được tính là sử dụng và giúp tài nguyên không bị dọn dẹp theo quy tắc này.
- Hãy sao lưu trước các tệp nguồn quan trọng. Nếu tài nguyên bị xóa, bạn cần nhập lại; tài nguyên nhập lại sẽ nhận được ID mới.
...
TokenLab giữ tài nguyên trong thư viện tài nguyên của tổ chức cho đến khi bạn xóa tài nguyên đó hoặc nhóm tài nguyên chứa nó. Tài nguyên lâu không được tham chiếu cũng sẽ bị dọn tự động theo quy tắc thời hạn lưu giữ tài nguyên ở trên.
