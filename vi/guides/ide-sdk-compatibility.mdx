...
<AccordionGroup>
  ...
  <Accordion title="Chỉ sử dụng stream_options.include_usage cho Chat Completions">
    Đối với streaming Chat Completions, hãy bật `stream_options.include_usage` để có số lượng token chính xác. Responses có hợp đồng streaming riêng và không công khai tùy chọn chỉ dành cho Chat này.
  </Accordion>
