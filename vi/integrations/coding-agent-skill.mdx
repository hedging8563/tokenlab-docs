...
| Yêu cầu non-chat không tương thích | `supported_operations`, `supported_parameters`, `request_endpoint`, `request_endpoint_by_operation`, `request_shape_mode`, `recommended_request` | Dựng lại yêu cầu từ chi tiết model và trả về lỗi rõ ràng cho các trường làm thay đổi ý định |
