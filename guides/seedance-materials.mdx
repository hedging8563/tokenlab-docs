...
Seedance materials let you reuse an image, video, or audio file without importing it for every generation. References to a real person require consent and visual verification; other people, products, and styles do not.

## Choose a material type

| What you want to reuse | What to do |
|------|---------------|
| One image used once | Send its URL in the video request; compatible Seedance models prepare it automatically |
