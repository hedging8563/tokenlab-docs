...
| --- | --- | --- |
| `invalid_api_key` | The API key is missing or not valid | Check the Authorization header and key value |
| `expired_api_key` | The key has expired or been revoked | Create or select an active key |
