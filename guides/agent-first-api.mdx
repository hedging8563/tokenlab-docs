...
This page describes machine-readable public API errors for applications and coding agents. It does not grant access to workspace request investigations or support. For a request in your workspace, start with [request troubleshooting](/guides/observability-troubleshooting).
