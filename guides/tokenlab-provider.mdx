...
- For OpenClaw **2026.9.4**, use Node.js `>=24.16.0 <25 || >=26.1.0` ([version requirements](https://github.com/openclaw/openclaw/blob/v2026.9.4/package.json)). For other OpenClaw releases, check that release's requirements.
