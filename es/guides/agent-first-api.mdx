...
Este ejemplo corrige un nombre de modelo solo cuando la API devuelve `did_you_mean`. Añada confirmación del usuario si cambiar de modelo puede alterar la calidad, el precio o el manejo de datos en su producto.
