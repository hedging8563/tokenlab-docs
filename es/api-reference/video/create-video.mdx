---
title: "Crear video"
openapi: "/openapi/es.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  ID de material Seedance de TokenLab devuelto por [Crear material](/es/api-reference/video/create-material-asset). Úsalo después de que el material esté `ACTIVE` con modelos Seedance que puedan usar la biblioteca de materiales de TokenLab.
</ParamField>
