...
Consultez la page d’intégration correspondante pour configurer le client et connaître les limites du modèle. Le [démarrage rapide](/fr/quickstart) contient une première requête complète.
## SDKs recommandés
