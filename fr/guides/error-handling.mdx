...
| --- | --- | --- |
| `invalid_api_key` | La clé API est manquante ou invalide | Vérifiez l'en-tête Authorization et la valeur de la clé |
| `expired_api_key` | La clé a expiré ou a été révoquée | Créez ou sélectionnez une clé active |
