...
openapi: "/openapi/fr.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  ID de matériau Seedance TokenLab renvoyé par [Créer un matériau](/fr/api-reference/video/create-material-asset). Utilisez-le après le statut `ACTIVE` avec les modèles Seedance qui peuvent utiliser la bibliothèque de matériaux TokenLab.
</ParamField>
