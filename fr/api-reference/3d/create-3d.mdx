...
openapi: "/openapi/fr.json POST /v1/3d/generations"
...
Avant d’envoyer des champs facultatifs, consultez les paramètres acceptés par le modèle avec `GET /v1/models/{model}`. L’exemple envoie uniquement `model` et `prompt`.

<ParamField body="model" type="string" default="tripo-h3.1">
  Modèle à utiliser, par exemple `tripo-h3.1` ou `tripo-p1.0`. Consultez `GET /v1/models?recommended_for=3d` avant de choisir un type d’entrée ou un format de sortie précis.
</ParamField>
...
<ParamField body="format" type="string">
  Format de sortie ; la prise en charge et les valeurs acceptées dépendent du modèle choisi.
</ParamField>

<ParamField body="quality" type="string">
  Réglage de qualité ; la prise en charge et les valeurs acceptées dépendent du modèle choisi.
</ParamField>
...
<ParamField body="seed" type="integer">
  Graine entière, si le modèle choisi la prend en charge.
</ParamField>
