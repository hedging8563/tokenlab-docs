...
https://docs.tokenlab.sh/fr/integrations/coding-agent-skill
```
...
Pour les questions API ou de compte, utilisez le [support intégré](https://tokenlab.sh/dashboard/support), vérifiez l’aperçu et envoyez explicitement. Pour une requête précise, partez de [Requêtes](https://tokenlab.sh/dashboard/runs) et du [guide de dépannage](/fr/guides/observability-troubleshooting). Signalez les défauts du Skill dans [GitHub Issues](https://github.com/hedging8563/tokenlab-skills/issues).
