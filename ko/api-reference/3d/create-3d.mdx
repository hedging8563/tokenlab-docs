---
title: "3D 모델 생성"
openapi: "/openapi/ko.json POST /v1/3d/generations"
...
선택 필드를 보내기 전에 `GET /v1/models/{model}`에서 모델이 허용하는 매개변수를 확인하세요. 예제는 `model`과 `prompt`만 보냅니다.
...
<ParamField body="format" type="string">
  출력 형식입니다. 지원 여부와 허용 값은 선택한 모델에 따라 다릅니다.
</ParamField>

<ParamField body="quality" type="string">
  품질 설정입니다. 지원 여부와 허용 값은 선택한 모델에 따라 다릅니다.
</ParamField>
