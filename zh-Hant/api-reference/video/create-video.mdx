---
title: "建立影片"
openapi: "/openapi/zh-Hant.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  [建立素材](/zh-Hant/api-reference/video/create-material-asset)回傳的 TokenLab Seedance 素材 ID。素材變為 `ACTIVE` 後，可在能夠使用 TokenLab 素材庫的 Seedance 模型中使用。
</ParamField>
