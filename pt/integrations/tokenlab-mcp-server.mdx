...
Em qualquer cliente stdio local, use o nome `tokenlab`, o comando `npx`, os argumentos separados `-y` e `@tokenlabai/mcp-server`, e deixe o diretório de trabalho vazio. Use `@tokenlabai/mcp-server@0.6.19` para fixar a versão atualmente verificada.
