---
title: "Criar vídeo"
openapi: "/openapi/pt.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  ID de material Seedance do TokenLab retornado por [Criar material](/pt/api-reference/video/create-material-asset). Use-o após o material ficar `ACTIVE` com modelos Seedance que possam usar a biblioteca de materiais do TokenLab.
</ParamField>
