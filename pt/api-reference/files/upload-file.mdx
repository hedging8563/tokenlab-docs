...
openapi: "/openapi/pt.json POST /v1/files"
description: "Envie um arquivo de lote, uma referência de imagem ou um arquivo no formato Anthropic."
---
...
- O `file_id` retornado fica vinculado ao mesmo espaço de trabalho compatível com Anthropic e deve ser reutilizado em solicitações `/v1/messages`.
