...
Esta página descreve erros da API pública legíveis por aplicações e agentes de programação. Não concede acesso a investigações do workspace nem ao suporte. Para suas solicitações, consulte a [solução de problemas](/pt/guides/observability-troubleshooting).
