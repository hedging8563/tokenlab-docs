...
| --- | --- | --- |
| `invalid_api_key` | A API key está ausente ou não é válida | Verifique o cabeçalho Authorization e o valor da chave |
| `expired_api_key` | A chave expirou ou foi revogada | Crie ou selecione uma chave ativa |
