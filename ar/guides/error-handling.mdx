...
| --- | --- | --- |
| `invalid_api_key` | مفتاح API مفقود أو غير صالح | تحقق من ترويسة Authorization وقيمة المفتاح |
| `expired_api_key` | المفتاح منتهي الصلاحية أو تم إلغاؤه | أنشئ أو اختر مفتاحًا نشطًا |
