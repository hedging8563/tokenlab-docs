...
openapi: "/openapi/ar.json POST /v1/3d/generations"
...
قبل إرسال الحقول الاختيارية، راجع المعلمات التي يقبلها النموذج عبر `GET /v1/models/{model}`. يرسل المثال `model` و`prompt` فقط.
...
<ParamField body="format" type="string">
  صيغة الإخراج؛ يعتمد الدعم والقيم المقبولة على النموذج المحدد.
</ParamField>

<ParamField body="quality" type="string">
  إعداد الجودة؛ يعتمد الدعم والقيم المقبولة على النموذج المحدد.
</ParamField>
...
<ParamField body="seed" type="integer">
  بذرة عددية صحيحة، إذا كان النموذج المحدد يدعمها.
</ParamField>
