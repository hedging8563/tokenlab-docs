---
title: "List API Keys"
openapi: "/openapi.json GET /v1/management/api-keys"
...
<ParamField query="limit" type="integer" default="50">Page size from 1 to 100.</ParamField>
...
<ResponseField name="data[].status" type="string">One of `active`, `inactive`, `suspended`, or `revoked`.</ResponseField>
...
<ResponseField name="data[].delivery_policy" type="string | null">`auto`, `verified`, `official`, `null`. `null` inherits the Workspace delivery policy.</ResponseField>
