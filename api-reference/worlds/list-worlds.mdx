---
title: "List Worlds"
openapi: "/openapi.json POST /v1/worlds/list"
...
<ParamField body="status" type="string">
  Optional filter: `SUCCEEDED`, `PENDING`, `RUNNING`, or `FAILED`. This endpoint lists completed worlds; the other three values return an empty list. Query generation tasks for their progress.
</ParamField>
