...
| --- | --- | --- |
| `invalid_api_key` | API anahtarı eksik veya geçerli değil | Authorization başlığını ve anahtar değerini kontrol edin |
| `expired_api_key` | Anahtarın süresi dolmuş veya iptal edilmiş | Aktif bir anahtar oluşturun veya seçin |
