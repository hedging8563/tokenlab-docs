...
openapi: "/openapi/tr.json POST /v1/images/generations"
...
- `nano-banana-2`, hem text-to-image hem de image-to-image için `aspect_ratio` ve `resolution` (`1k`, `2k`, `4k`) destekler.
...
<ParamField body="resolution" type="string">
  Çıktı çözünürlüğü modele bağlıdır. `gemini-3.1-flash-image`, `gemini-3-pro-image`, `nano-banana-2` ve `nano-banana-pro`, `1k`, `2k`, `4k` değerlerini; Grok Imagine görsel modelleri `1k` ve `2k` değerlerini destekler. Bu alanı yalnızca seçilen model ve işlem açıkça destekliyorsa gönderin.
</ParamField>
...
Güncel görsel modelleri, yetenekleri ve fiyatları için `GET /v1/models?recommended_for=image` kullanın.
