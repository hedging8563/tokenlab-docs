...
openapi: "/openapi/tr.json POST /v1/3d/generations"
...
İsteğe bağlı alanları göndermeden önce `GET /v1/models/{model}` ile modelin kabul ettiği parametreleri kontrol edin. Örnek yalnızca `model` ve `prompt` gönderir.

<ParamField body="model" type="string" default="tripo-h3.1">
  Kullanılacak model, örneğin `tripo-h3.1` veya `tripo-p1.0`. Belirli bir giriş türü veya çıktı biçimine güvenmeden önce `GET /v1/models?recommended_for=3d` sorgulayın.
</ParamField>
...
<ParamField body="format" type="string">
  Çıktı biçimi; destek ve izin verilen değerler seçilen modele bağlıdır.
</ParamField>

<ParamField body="quality" type="string">
  Kalite ayarı; destek ve izin verilen değerler seçilen modele bağlıdır.
</ParamField>
...
<ParamField body="seed" type="integer">
  Seçilen model destekliyorsa kullanılabilen tam sayı seed.
</ParamField>
