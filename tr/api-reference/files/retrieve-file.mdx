---
title: "Dosyayı Al"
openapi: "/openapi/tr.json GET /v1/files/{file_id}"
...
## Görüntü Referans Dosyaları

Bu uç nokta, TokenLab tarafından oluşturulan görüntü referans dosyalarının meta verilerini de döndürebilir. `status` alanı isteğe bağlıdır ve bu alanı sağlamayan dosya ailelerinde bulunmayabilir.
