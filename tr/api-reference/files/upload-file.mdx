---
title: "Dosya Yükle"
openapi: "/openapi/tr.json POST /v1/files"
description: "Batch dosyası, görüntü referansı veya Anthropic biçimli bir dosya yükleyin."
---
...
- Dönen `file_id`, aynı Anthropic uyumlu çalışma alanına bağlanır ve sonraki `/v1/messages` isteklerinde yeniden kullanılmalıdır.
