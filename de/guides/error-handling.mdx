...
| --- | --- | --- |
| `invalid_api_key` | Der API-Key fehlt oder ist nicht gültig | Authorization-Header und Key-Wert überprüfen |
| `expired_api_key` | Der Key ist abgelaufen oder wurde widerrufen | Aktiven Key erstellen oder auswählen |
