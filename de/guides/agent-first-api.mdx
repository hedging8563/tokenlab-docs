...
Diese Seite behandelt maschinenlesbare Fehler der öffentlichen API für Anwendungen und Coding-Agenten. Sie gewährt keinen Zugriff auf Workspace-Untersuchungen oder Support. Für eigene Anfragen nutzen Sie die [Fehlersuche](/de/guides/observability-troubleshooting).
