...
openapi: "/openapi/de.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  TokenLab Seedance-Material-ID aus [Material erstellen](/de/api-reference/video/create-material-asset). Verwenden Sie sie nach `ACTIVE` mit Seedance-Modellen, die die TokenLab-Materialbibliothek verwenden können.
</ParamField>
