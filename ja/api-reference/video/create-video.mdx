---
title: "動画を作成"
openapi: "/openapi/ja.json POST /v1/videos/generations"
...
<ParamField body="material_asset_id" type="string">
  [素材を作成](/ja/api-reference/video/create-material-asset)で返される TokenLab Seedance 素材 ID。素材が `ACTIVE` になった後、TokenLab 素材ライブラリを使用できる Seedance モデルで使用できます。
</ParamField>
